...
add wave -noupdate /tb/UUT/addine
add wave -noupdate /tb/UUT/bregwrite_mainctrl
add wave -noupdate /tb/UUT/addrpos
...
WaveRestoreCursors {{Cursor 1} {78346 ps} 0}
...
update
WaveRestoreZoom {70113 ps} {117363 ps}
